    ...
    <View style={styles.container}>
      <View style={styles.formContainer}>
        ...
        <Text style={styles.subTitle}>
          Isi form login agar kamu dapat terhubung dengan akunmu
        </Text>
        ...
        />
        <Gap height={15} />
        <Button prior="primary" title="Login" onpress={() => loginFunc()} />

        <Gap height={15} />
        <View
          style={{height: 1, backgroundColor: '#a0a0a0', alignSelf: 'stretch'}}
        />
        <Gap height={15} />
        <Button
          prior="secondary"
