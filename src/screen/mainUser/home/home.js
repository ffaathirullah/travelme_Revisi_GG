      ...
      <View>
        ...
        <View>
          <Text style={styles.explore}>
            Pilih Area Wisata Terlebih dahulu !
          </Text>
          <Gap height={20} />
        ...
        <Gap height={30} />
        <Text style={styles.explore2}>
          Setelah memilih Area wisata diatas klik Tombol dibawah untuk mulai
          berwisata
        </Text>
        <Gap height={20} />
        <View style={styles.layanan}>
          <TouchableOpacity
            onPress={() => navigation.push('nextHome')}
            style={{
              flex: 1,
              paddingVertical: 4,
              borderRadius: 4,
